...
@Component({
  selector: 'app-mawsua-manhajusul',
  templateUrl: './mawsua-manhajusul.page.html',
  styleUrls: ['./mawsua-manhajusul.page.scss'],
})
export class MawsuaManhajusulPage implements OnInit {
  loaderToShow: any;
  public title;
  public link;
  public book = [];
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-manhajusul.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
