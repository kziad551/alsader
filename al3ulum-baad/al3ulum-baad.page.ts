...
@Component({
  selector: 'app-al3ulum-baad',
  templateUrl: './al3ulum-baad.page.html',
  styleUrls: ['./al3ulum-baad.page.scss'],
})
export class Al3ulumBaadPage implements OnInit {
  ...
  ionViewWillEnter(){
     this.storage.clear();
     this.storage.set('page', 'al3ulum-baad');
   }
  ...
  ngOnInit() {
    const url= 'https://strapi.alsader.net/api/pdfs?filters[pdf_category][title][$eq]=ouloum-ba3d-estshhad&populate=*'
