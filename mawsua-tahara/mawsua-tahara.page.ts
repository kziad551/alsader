...
@Component({
  selector: 'app-mawsua-tahara',
  templateUrl: './mawsua-tahara.page.html',
  styleUrls: ['./mawsua-tahara.page.scss'],
})
export class MawsuaTaharaPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-tahara.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
