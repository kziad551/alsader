...
@Component({
  selector: 'app-markad-alsayed-images',
  templateUrl: './markad-alsayed-images.page.html',
  styleUrls: ['./markad-alsayed-images.page.scss'],
})
export class MarkadAlsayedImagesPage implements OnInit {
...
function getXMLDataImage( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/images-xml/markad-alsayed.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
