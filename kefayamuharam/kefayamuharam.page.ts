...
@Component({
  selector: 'app-kefayamuharam',
  templateUrl: './kefayamuharam.page.html',
  styleUrls: ['./kefayamuharam.page.scss'],
})
export class KefayamuharamPage implements OnInit {
 private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-muharam-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/muharam-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
