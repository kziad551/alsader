...
@Component({
  selector: 'app-kefaya1419muharam',
  templateUrl: './kefaya1419muharam.page.html',
  styleUrls: ['./kefaya1419muharam.page.scss'],
})
export class Kefaya1419muharamPage implements OnInit {
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/muharam-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
