...
@Component({
  selector: 'app-alusul14216',
  templateUrl: './alusul14216.page.html',
  styleUrls: ['./alusul14216.page.scss'],
})
export class Alusul14216Page implements OnInit {
  ...
  ionViewWillEnter(){
    ...
    this.storage.set('page-aldurus', 'alusul14216');
  }
  moveToPage(pageName) {
