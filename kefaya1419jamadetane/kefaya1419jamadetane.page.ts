...
@Component({
  selector: 'app-kefaya1419jamadetane',
  templateUrl: './kefaya1419jamadetane.page.html',
  styleUrls: ['./kefaya1419jamadetane.page.scss'],
})
export class Kefaya1419jamadetanePage implements OnInit {

  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
        const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-jamade-tane-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/jamade-tane-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
