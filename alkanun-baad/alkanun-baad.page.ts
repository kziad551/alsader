...
@Component({
  selector: 'app-alkanun-baad',
  templateUrl: './alkanun-baad.page.html',
  styleUrls: ['./alkanun-baad.page.scss'],
})
export class AlkanunBaadPage implements OnInit {
  ...
  ionViewWillEnter(){
  this.storage.clear();
  this.storage.set('page', 'alkanun-baad');
}
