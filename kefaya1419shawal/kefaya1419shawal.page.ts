...
@Component({
  selector: 'app-kefaya1419shawal',
  templateUrl: './kefaya1419shawal.page.html',
  styleUrls: ['./kefaya1419shawal.page.scss'],
})
export class Kefaya1419shawalPage implements OnInit {
private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
       const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-shawal-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/shawal-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
