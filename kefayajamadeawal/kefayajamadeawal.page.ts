...
@Component({
  selector: 'app-kefayajamadeawal',
  templateUrl: './kefayajamadeawal.page.html',
  styleUrls: ['./kefayajamadeawal.page.scss'],
})
export class KefayajamadeawalPage implements OnInit {
  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/jamade-awal-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
