...
@Component({
  selector: 'app-mawsua-takrer3lmusul',
  templateUrl: './mawsua-takrer3lmusul.page.html',
  styleUrls: ['./mawsua-takrer3lmusul.page.scss'],
})
export class MawsuaTakrer3lmusulPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-takrer3lmusul.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
