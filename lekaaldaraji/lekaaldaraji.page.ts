...
@Component({
  selector: 'app-lekaaldaraji',
  templateUrl: './lekaaldaraji.page.html',
  styleUrls: ['./lekaaldaraji.page.scss'],
})
export class LekaaldarajiPage implements OnInit {
...
function getXMLDataMawaez( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawaez-lekaat-xml/lekaaaldaraji.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
