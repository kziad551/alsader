...
@Component({
  selector: 'app-lekaat-hewarat-shahed-hanana',
  templateUrl: './lekaat-hewarat-shahed-hanana.page.html',
  styleUrls: ['./lekaat-hewarat-shahed-hanana.page.scss'],
})
export class LekaatHewaratShahedHananaPage implements OnInit {
