...
@Component({
  selector: 'app-alkuraan-kabel',
  templateUrl: './alkuraan-kabel.page.html',
  styleUrls: ['./alkuraan-kabel.page.scss'],
})
export class AlkuraanKabelPage implements OnInit {
  ...
  ionViewWillEnter(){
this.storage.clear();
this.storage.set('page', 'alkuraan-kabel');
}
  ...
  ngOnInit() {
    const url= 'https://strapi.alsader.net/api/pdfs?filters[pdf_category][title][$eq]=tafsirkor2an-kabl-estshhad&populate=*'
