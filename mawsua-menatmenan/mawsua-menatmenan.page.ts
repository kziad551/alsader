...
@Component({
  selector: 'app-mawsua-menatmenan',
  templateUrl: './mawsua-menatmenan.page.html',
  styleUrls: ['./mawsua-menatmenan.page.scss'],
})
export class MawsuaMenatmenanPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-menatmenan.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
