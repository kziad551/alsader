...
@Component({
  selector: 'app-kefayashawal',
  templateUrl: './kefayashawal.page.html',
  styleUrls: ['./kefayashawal.page.scss'],
})
export class KefayashawalPage implements OnInit {
   private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-shawal-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/shawal-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
