...
@Component({
  selector: 'app-kefaya1419sefer',
  templateUrl: './kefaya1419sefer.page.html',
  styleUrls: ['./kefaya1419sefer.page.scss'],
})
export class Kefaya1419seferPage implements OnInit {

  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-sefer-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/sefer-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
