...
@Component({
  selector: 'app-alnajlayn-alshahedayn-eqra2',
  templateUrl: './alnajlayn-alshahedayn-eqra2.page.html',
  styleUrls: ['./alnajlayn-alshahedayn-eqra2.page.scss'],
})
export class AlnajlaynAlshahedaynEqra2Page implements OnInit {
