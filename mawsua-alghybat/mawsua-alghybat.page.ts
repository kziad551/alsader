...
@Component({
  selector: 'app-mawsua-alghybat',
  templateUrl: './mawsua-alghybat.page.html',
  styleUrls: ['./mawsua-alghybat.page.scss'],
})
export class MawsuaAlghybatPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-alghybat.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
