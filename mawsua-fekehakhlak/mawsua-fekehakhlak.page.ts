...
@Component({
  selector: 'app-mawsua-fekehakhlak',
  templateUrl: './mawsua-fekehakhlak.page.html',
  styleUrls: ['./mawsua-fekehakhlak.page.scss'],
})
export class MawsuaFekehakhlakPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-fekehakhlak.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
