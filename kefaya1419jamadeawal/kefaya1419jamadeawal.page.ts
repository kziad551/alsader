...
@Component({
  selector: 'app-kefaya1419jamadeawal',
  templateUrl: './kefaya1419jamadeawal.page.html',
  styleUrls: ['./kefaya1419jamadeawal.page.scss'],
})
export class Kefaya1419jamadeawalPage implements OnInit {
private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
    const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-jamade-awal-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/jamade-awal-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
