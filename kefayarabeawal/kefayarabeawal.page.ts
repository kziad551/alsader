...
@Component({
  selector: 'app-kefayarabeawal',
  templateUrl: './kefayarabeawal.page.html',
  styleUrls: ['./kefayarabeawal.page.scss'],
})
export class KefayarabeawalPage implements OnInit {

   private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-rabe3-awal-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/rabe3-awal-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
