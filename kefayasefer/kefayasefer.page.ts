...
@Component({
  selector: 'app-kefayasefer',
  templateUrl: './kefayasefer.page.html',
  styleUrls: ['./kefayasefer.page.scss'],
})
export class KefayaseferPage implements OnInit {

   private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-sefer-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/sefer-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
