...
@Component({
  selector: 'app-alejtemaa-baad',
  templateUrl: './alejtemaa-baad.page.html',
  styleUrls: ['./alejtemaa-baad.page.scss'],
})
export class AlejtemaaBaadPage implements OnInit {
  ...
  ionViewWillEnter(){
  this.storage.clear();
  this.storage.set('page', 'alejtemaa-baad');
}
