...
@Component({
  selector: 'app-kefaya1419rabetane',
  templateUrl: './kefaya1419rabetane.page.html',
  styleUrls: ['./kefaya1419rabetane.page.scss'],
})
export class Kefaya1419rabetanePage implements OnInit {
private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
     const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-rabe3-tane-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/rabe3-tane-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
