...
@Component({
  selector: 'app-kefaya1419zekaada',
  templateUrl: './kefaya1419zekaada.page.html',
  styleUrls: ['./kefaya1419zekaada.page.scss'],
})
export class Kefaya1419zekaadaPage implements OnInit {
  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-zulke3da-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/zelkada-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
