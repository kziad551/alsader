...
@Component({
  selector: 'app-sayed-salatjmaa-img',
  templateUrl: './sayed-salatjmaa-img.page.html',
  styleUrls: ['./sayed-salatjmaa-img.page.scss'],
})
export class SayedSalatjmaaImgPage implements OnInit {
...
function getXMLDataImage( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/images-xml/sayed-fi-salat-jmaa.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
