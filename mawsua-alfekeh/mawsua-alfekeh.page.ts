...
@Component({
  selector: 'app-mawsua-alfekeh',
  templateUrl: './mawsua-alfekeh.page.html',
  styleUrls: ['./mawsua-alfekeh.page.scss'],
})
export class MawsuaAlfekehPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-alfekh.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
