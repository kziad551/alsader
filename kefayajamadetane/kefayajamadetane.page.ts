...
@Component({
  selector: 'app-kefayajamadetane',
  templateUrl: './kefayajamadetane.page.html',
  styleUrls: ['./kefayajamadetane.page.scss'],
})
export class KefayajamadetanePage implements OnInit {
  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-jamade-tane-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/jamade-tane-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
