...
@Component({
  selector: 'app-mawsuaa-munawa3a',
  templateUrl: './mawsuaa-munawa3a.page.html',
  styleUrls: ['./mawsuaa-munawa3a.page.scss'],
})
export class MawsuaaMunawa3aPage implements OnInit {
  loaderToShow: any;
  public title;
  public link;
  public book = [];
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-munawa3a.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
