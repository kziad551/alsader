...
@Component({
  selector: 'app-mawsua-fatawa',
  templateUrl: './mawsua-fatawa.page.html',
  styleUrls: ['./mawsua-fatawa.page.scss'],
})
export class MawsuaFatawaPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-alfatawa.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
