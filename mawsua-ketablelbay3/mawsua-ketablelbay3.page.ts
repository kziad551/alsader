...
@Component({
  selector: 'app-mawsua-ketablelbay3',
  templateUrl: './mawsua-ketablelbay3.page.html',
  styleUrls: ['./mawsua-ketablelbay3.page.scss'],
})
export class MawsuaKetablelbay3Page implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-ketablelbay3.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
