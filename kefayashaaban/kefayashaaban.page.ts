...
@Component({
  selector: 'app-kefayashaaban',
  templateUrl: './kefayashaaban.page.html',
  styleUrls: ['./kefayashaaban.page.scss'],
})
export class KefayashaabanPage implements OnInit {

  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-shaaban-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/shaaban-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
