...
@Component({
  selector: 'app-mawsua-masael',
  templateUrl: './mawsua-masael.page.html',
  styleUrls: ['./mawsua-masael.page.scss'],
})
export class MawsuaMasaelPage implements OnInit {
  loaderToShow: any;
  public title;
  public link;
  public book = [];
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-masael.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
