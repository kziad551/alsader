...
@Component({
  ...
  templateUrl: './al-hetafat-mp3.page.html',
...
export class AlHetafatMp3Page implements OnInit {
  ...
  ngOnInit() {
   ...
   if( linkd == 'ar'){
      ...
      this.data = [];
      this.content = [];
      const url= 'https://strapi.alsader.net/api/khotab-al-jomaas?filters[khotab_al_jomaa_category][title][$eq]=khotabjmaa-hitafat-mp3&locale=ar-IQ'
      ...
      this.data = [];
      this.content = [];
      const url= 'https://strapi.alsader.net/api/khotab-al-jomaas?filters[khotab_al_jomaa_category][title][$eq]=khotabjmaa-hitafat-mp3&locale=en'
      this.http.get(url).subscribe((res)=>{
        this.data = res
        var i =0;
        for ( i=0; i< this.data.data.length; i++ ) {
      ...
      this.data = [];
      this.content = [];
      const url= 'https://strapi.alsader.net/api/khotab-al-jomaas?filters[khotab_al_jomaa_category][title][$eq]=khotabjmaa-hitafat-mp3&locale=fa-IR'
      this.http.get(url).subscribe((res)=>{
        this.data = res
        var i =0;
        for ( i=0; i< this.data.data.length; i++ ) {
