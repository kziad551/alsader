...
@Component({
  ...
  styleUrls: ['./kefaya1419rabeawal.page.scss'],
})
export class Kefaya1419rabeawalPage implements OnInit {

  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
    const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-rabe3-awal-1419&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1419/rabe3-awal-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
