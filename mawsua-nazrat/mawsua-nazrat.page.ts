...
@Component({
  selector: 'app-mawsua-nazrat',
  templateUrl: './mawsua-nazrat.page.html',
  styleUrls: ['./mawsua-nazrat.page.scss'],
})
export class MawsuaNazratPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-nazrat.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
