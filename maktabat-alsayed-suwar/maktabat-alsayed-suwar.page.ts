...
@Component({
  selector: 'app-maktabat-alsayed-suwar',
  templateUrl: './maktabat-alsayed-suwar.page.html',
  styleUrls: ['./maktabat-alsayed-suwar.page.scss'],
})
export class MaktabatAlsayedSuwarPage implements OnInit {
...
function getXMLDataImage( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/images-xml/maktabet-alsayed.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
