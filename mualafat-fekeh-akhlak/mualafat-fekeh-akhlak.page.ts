...
@Component({
  selector: 'app-mualafat-fekeh-akhlak',
  templateUrl: './mualafat-fekeh-akhlak.page.html',
  styleUrls: ['./mualafat-fekeh-akhlak.page.scss'],
})
export class MualafatFekehAkhlakPage implements OnInit {
  ...
  public content:any[] = [];
   ...
   constructor(private http: HttpClient,private document: DocumentViewer,private transfer: FileTransfer,private fileOpener: FileOpener, private file: File,private storage: Storage,private platform: Platform,private router: Router,private popoverCtrl: PopoverController,private popoverController: PopoverController,public loadingController: LoadingController) {
    ...
    ionViewWillEnter(){
        ...
        this.storage.set('page', 'mualafat-fekeh-akhlak');
    ...
    ngOnInit() {
      const url= 'https://strapi.alsader.net/api/pdfs?filters[pdf_category][title][$eq]=fokeh-al-akhlak&populate=*'
