...
@Component({
  selector: 'app-kefayarajab',
  templateUrl: './kefayarajab.page.html',
  styleUrls: ['./kefayarajab.page.scss'],
})
export class KefayarajabPage implements OnInit {
  private data:any = [];
  public title:any[] = [];
  public content:any[] = [];
  ngOnInit() {
      const url ='https://strapi.alsader.net/api/aduruses?filters[adurus_cat][title][$eq]=kefaya-kefaya-rajab-1418&populate=*'
...
//   try {
//     request.open('GET', 'assets/aldurus-mp3/aldurus-kefaya1418/rajab-mp3.xml', false);
//     request.send(null);
//   } catch (err) {
//     return '';
//   }
