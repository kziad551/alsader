...
@Component({
  selector: 'app-altarekh-kabel',
  templateUrl: './altarekh-kabel.page.html',
  styleUrls: ['./altarekh-kabel.page.scss'],
})
export class AltarekhKabelPage implements OnInit {
  ...
  ngOnInit() {
    const url= 'https://strapi.alsader.net/api/pdfs?filters[pdf_category][title][$eq]=tarikh-kabl-estshhad&populate=*'
