...
@Component({
  selector: 'app-lekaat-hewarat-shahed-daraji',
  templateUrl: './lekaat-hewarat-shahed-daraji.page.html',
  styleUrls: ['./lekaat-hewarat-shahed-daraji.page.scss'],
})
export class LekaatHewaratShahedDarajiPage implements OnInit {
