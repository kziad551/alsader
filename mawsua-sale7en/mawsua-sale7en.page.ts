...
@Component({
  selector: 'app-mawsua-sale7en',
  templateUrl: './mawsua-sale7en.page.html',
  styleUrls: ['./mawsua-sale7en.page.scss'],
})
export class MawsuaSale7enPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-manhajsale7en.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
