...
@Component({
  selector: 'app-mawsua-bu7us',
  templateUrl: './mawsua-bu7us.page.html',
  styleUrls: ['./mawsua-bu7us.page.scss'],
})
export class MawsuaBu7usPage implements OnInit {
...
function getXMLDataPDF( itemname:string ) {
  ...
  try {
    request.open('GET', 'assets/mawsuaat-xml/mawsuaa-bu7us.xml', false);
    request.send(null); 
  } catch (err) {  
    return '';
  }
